...
from client.torrent_error import torrent_error
from client.torrent_logger import *
from client.peer_wire_messages import *
from client.shared_file_handler import torrent_shared_file_handler
from client.peer_socket import *
from client.peer_state import *
...
class peer():
    ...
    def validate_request_piece_messages(self, request, piece):
        ...
        if request.block_length != len(piece.block):
            # print(f"block_length -> {request.block_length}, piece_block_length -> {len(piece.block)}")
            return False
        return True
