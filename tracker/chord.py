    ...
    def start_server(self):
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            while True:
                ...
                r = f"new connection from {addr} with {option} action"
                print(r)
                ...
                print(f"{r}, and the response was {data_resp}")
